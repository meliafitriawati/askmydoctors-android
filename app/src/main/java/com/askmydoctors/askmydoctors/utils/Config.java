...
public class Config {
    ...
    public static final String URL = "http://192.168.1.3/askmydoctors/api/";
    public static final String URL_WEB = "http://192.168.1.3/askmydoctors/";
    ...
    public static String getString(Context con, String key){
        settings = con.getSharedPreferences(SP_CONFIG, 0);
        String val = settings.getString(key, "");
        return val;
    }
